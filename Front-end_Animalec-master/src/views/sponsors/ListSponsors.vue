          ...
          <table class="table table-striped">
            <thead class="thead-dark">
              <tr>
                ...
                <th scope="col">ANIMAL APOIADO</th>
                <th scope="col">MONTANTE PATROCINADO (€)</th>
            ...
            <tbody>
              <tr v-for="sponsor of sponsors" :key="sponsor._id">
                ...
                <td class="pt-4">{{ sponsor.supportedanimal }}</td>
                <td class="pt-4">{{ sponsor.sponsoredamount }}</td>
                <td>
                  <router-link
                    :to="{
                      name: 'editSponsor',
...
export default {
  ...
  methods: {
    ...
    generateTemplate(sponsor) {
      return `
          <h4>Animal Apoiado:</b> ${sponsor.supportedanimal}</h4>
          <h5>(Montante Patrocinado:</b> ${sponsor.sponsoredamount} € )</h5>
        `;
    },
    removeSponsor(id) {
      this.$confirm(
